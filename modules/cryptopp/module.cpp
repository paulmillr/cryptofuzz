...
namespace CryptoPP_detail {
    const ::CryptoPP::DL_GroupParameters_EC<::CryptoPP::ECP>& ResolveCurve(const component::CurveType& curveType) {
        static const std::map<uint64_t, const ::CryptoPP::DL_GroupParameters_EC<::CryptoPP::ECP>> LUT = {
            ...
            { CF_ECC_CURVE("secp192r1"), ::CryptoPP::ASN1::secp192r1() },
            ...
            { CF_ECC_CURVE("secp256r1"), ::CryptoPP::ASN1::secp256r1() },
            { CF_ECC_CURVE("secp384r1"), ::CryptoPP::ASN1::secp384r1() },
            { CF_ECC_CURVE("secp521r1"), ::CryptoPP::ASN1::secp521r1() },
            { CF_ECC_CURVE("sect113r1"), ::CryptoPP::ASN1::sect113r1() },
            { CF_ECC_CURVE("sect113r2"), ::CryptoPP::ASN1::sect113r2() },
            { CF_ECC_CURVE("sect131r1"), ::CryptoPP::ASN1::sect131r1() },
            { CF_ECC_CURVE("sect131r2"), ::CryptoPP::ASN1::sect131r2() },
            { CF_ECC_CURVE("sect163k1"), ::CryptoPP::ASN1::sect163k1() },
            { CF_ECC_CURVE("sect163r1"), ::CryptoPP::ASN1::sect163r1() },
            { CF_ECC_CURVE("sect163r2"), ::CryptoPP::ASN1::sect163r2() },
            { CF_ECC_CURVE("sect193r1"), ::CryptoPP::ASN1::sect193r1() },
            { CF_ECC_CURVE("sect193r2"), ::CryptoPP::ASN1::sect193r2() },
            { CF_ECC_CURVE("sect233k1"), ::CryptoPP::ASN1::sect233k1() },
            { CF_ECC_CURVE("sect233r1"), ::CryptoPP::ASN1::sect233r1() },
            { CF_ECC_CURVE("sect239k1"), ::CryptoPP::ASN1::sect239k1() },
            { CF_ECC_CURVE("sect283k1"), ::CryptoPP::ASN1::sect283k1() },
            { CF_ECC_CURVE("sect283r1"), ::CryptoPP::ASN1::sect283r1() },
            { CF_ECC_CURVE("sect409k1"), ::CryptoPP::ASN1::sect409k1() },
            { CF_ECC_CURVE("sect409r1"), ::CryptoPP::ASN1::sect409r1() },
            { CF_ECC_CURVE("sect571k1"), ::CryptoPP::ASN1::sect571k1() },
            { CF_ECC_CURVE("sect571r1"), ::CryptoPP::ASN1::sect571r1() },
            { CF_ECC_CURVE("sm2p256v1"), ::CryptoPP::ASN1::sm2p256v1() },
        };
