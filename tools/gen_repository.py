...
class KEM(Component):
    def __init__(self, kem):
        super(KEM, self).__init__(kem)

class PQSignature(Component):
    def __init__(self, signature):
        super(PQSignature, self).__init__(signature)
...
class KEMTable(Table):
    def __init__(self):
        super(KEMTable, self).__init__('KEM', [])
    def getTableEntryList(self, index):
        return []

class PQSignatureTable(Table):
    def __init__(self):
        super(PQSignatureTable, self).__init__('PQSIG', [])
    def getTableEntryList(self, index):
        return []
...
operations.Add( Operation("KEM_KeyGen") )
operations.Add( Operation("Misc") )
operations.Add( Operation("PQSIG_KeyGen") )
operations.Add( Operation("PQSIG_Sign") )
operations.Add( Operation("PQSIG_Verify") )
...
kems = KEMTable()
# lint sort start
kems.Add( KEM("KitchenSink-ML-KEM-768-X25519") )
kems.Add( KEM("ML-KEM-1024") )
kems.Add( KEM("ML-KEM-1024-P384") )
kems.Add( KEM("ML-KEM-512") )
kems.Add( KEM("ML-KEM-768") )
kems.Add( KEM("ML-KEM-768-P256") )
kems.Add( KEM("ML-KEM-768-X25519") )
kems.Add( KEM("QSF-ML-KEM-1024-P384") )
kems.Add( KEM("QSF-ML-KEM-768-P256") )
kems.Add( KEM("X-Wing") )
# lint sort end

pqsignatures = PQSignatureTable()
# lint sort start
pqsignatures.Add( PQSignature("Falcon-1024") )
pqsignatures.Add( PQSignature("Falcon-512") )
pqsignatures.Add( PQSignature("ML-DSA-44") )
pqsignatures.Add( PQSignature("ML-DSA-65") )
pqsignatures.Add( PQSignature("ML-DSA-87") )
pqsignatures.Add( PQSignature("SLH-DSA-SHA2-128f") )
pqsignatures.Add( PQSignature("SLH-DSA-SHA2-128s") )
pqsignatures.Add( PQSignature("SLH-DSA-SHA2-192f") )
pqsignatures.Add( PQSignature("SLH-DSA-SHA2-192s") )
pqsignatures.Add( PQSignature("SLH-DSA-SHA2-256f") )
pqsignatures.Add( PQSignature("SLH-DSA-SHA2-256s") )
pqsignatures.Add( PQSignature("SLH-DSA-SHAKE-128f") )
pqsignatures.Add( PQSignature("SLH-DSA-SHAKE-128s") )
pqsignatures.Add( PQSignature("SLH-DSA-SHAKE-192f") )
pqsignatures.Add( PQSignature("SLH-DSA-SHAKE-192s") )
pqsignatures.Add( PQSignature("SLH-DSA-SHAKE-256f") )
pqsignatures.Add( PQSignature("SLH-DSA-SHAKE-256s") )
# lint sort end
...
tables = [modules, operations, kems, pqsignatures, ciphers, digests, ecc_curves, calcops]
