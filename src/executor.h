...
using ExecutorKEM_KeyGen = ExecutorBase<component::KEMKeyPair, operation::KEM_KeyGen>;
using ExecutorKEM_Encapsulate = ExecutorBase<component::KEMEncapsulation, operation::KEM_Encapsulate>;
using ExecutorKEM_Decapsulate = ExecutorBase<component::SharedSecret, operation::KEM_Decapsulate>;
using ExecutorPQSIG_KeyGen = ExecutorBase<component::PQSignatureKeyPair, operation::PQSIG_KeyGen>;
using ExecutorPQSIG_Sign = ExecutorBase<component::PQSignature, operation::PQSIG_Sign>;
using ExecutorPQSIG_Verify = ExecutorBase<bool, operation::PQSIG_Verify>;
