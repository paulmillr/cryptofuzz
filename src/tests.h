...
void test(const operation::KEM_KeyGen& op, const std::optional<component::KEMKeyPair>& result);
void test(const operation::KEM_Encapsulate& op, const std::optional<component::KEMEncapsulation>& result);
void test(const operation::KEM_Decapsulate& op, const std::optional<component::SharedSecret>& result);
void test(const operation::PQSIG_KeyGen& op, const std::optional<component::PQSignatureKeyPair>& result);
void test(const operation::PQSIG_Sign& op, const std::optional<component::PQSignature>& result);
void test(const operation::PQSIG_Verify& op, const std::optional<bool>& result);
