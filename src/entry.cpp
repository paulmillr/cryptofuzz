...
#if defined(CRYPTOFUZZ_NOBLE_CIPHERS)
  #include <modules/noble-ciphers/module.h>
#endif

#if defined(CRYPTOFUZZ_NOBLE_POST_QUANTUM)
  #include <modules/noble-post-quantum/module.h>
#endif
...
#if defined(CRYPTOFUZZ_NOBLE_CIPHERS)
    driver->LoadModule( std::make_shared<cryptofuzz::module::noble_ciphers>() );
#endif

#if defined(CRYPTOFUZZ_NOBLE_POST_QUANTUM)
    driver->LoadModule( std::make_shared<cryptofuzz::module::noble_post_quantum>() );
#endif
